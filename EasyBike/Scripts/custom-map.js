...
function createBikesMap(_latitude, _longitude, bikes) {
    setCustomMapHeight();
    if (document.getElementById('map') != null) {
        var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 15,
            ...
            for (i = 0; i < projects.length; i++) {
                var pictureLabel = document.createElement("img");
                pictureLabel.src = projects[i].IconLink;;
                var boxText = document.createElement("div");
                infoboxOptions = {
                    content: boxText,
                    disableAutoPan: false,
                    ...
                    enableEventPropagation: true,
                    closeBoxMargin: "0px 0px -8px 0px",
                    closeBoxURL: "/assetsFrontend/img/close-btn.png",
                    infoBoxClearance: new google.maps.Size(1, 1)
                };
                var marker = new MarkerWithLabel({
                    ...
                    map: map,
                    icon: '/assetsFrontend/img/marker.png',
                    labelContent: pictureLabel,
                    labelAnchor: new google.maps.Point(50, 0),
                    labelClass: "marker-style"
                });
                ...
                boxText.innerHTML =
                    '<div class="infobox-inner">' +
                        ...
                        '</a>' +
                        '<div class="infobox-description">' +
                        '<div class="infobox-title"><a href="' + projects[i].Link + '">' + projects[i].Title + '</a></div>' +
                        '<div class="infobox-location">' + projects[i].Municipality + '</div>' +
                        '</div>' +
                        '</div>';
                //Define the infobox
                newMarkers[i].infobox = new InfoBox(infoboxOptions);
            ...
            var clusterStyles = [
                {
                    url: '/assetsFrontend/img/cluster.png',
                    height: 37,
                    width: 37
                }
            ];
...
function initMyMap(lat,long, iconSrc) {
        var subtractPosition = 0;
        var mapWrapper = $('#property-detail-map.float');
